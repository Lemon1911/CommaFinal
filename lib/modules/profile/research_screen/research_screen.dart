        ...
        builder: (context, state) {
          ...
          return Scaffold(
            appBar: AppBar(
              ...
              title: defaultText(
                  bold: true, size: 26.0, text: 'Research', color: '#265AE8'),
            ),
            body: Padding(
              ...
              child: Column(
                children: [
                  ...
                  if (state is! UploadMaterialLoading)
                    defaultAccessButton(
                        function: () {
                          appCubit.uploadResearch(file: file);
                        },
                        text: 'Upload New Research'),
                  SizedBox(
                    height: 20,
                  ),
                  Row(
                  ...
                  if(state is! GetMaterialLoading) Expanded(
                    child: ListView.separated(
                        ...
                        itemBuilder: (context, index) => defaultListResearch(
...
Widget defaultListResearch({width, material}) => (material['collection_name'] == 'researches') ?Container(
