        ...
        builder: (context, state) {
          ...
          return Scaffold(
            appBar: AppBar(
              ...
              title: defaultText(
                  bold: true, size: 26.0, text: 'CV', color: '#265AE8'),
            ),
            body: Padding(
                ...
                children: [
                  ...
                  if(state is! GetMaterialLoading) Expanded(
                    child: ListView.separated(
                        ...
                        itemBuilder: (context, index) => defaultListCv(
...
Widget defaultListCv({width, material}) => (material['collection_name'] == 'cv') ?Container(
